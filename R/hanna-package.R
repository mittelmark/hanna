...
#' \alias{hanna}
#' \alias{hanna-package}
#' \title{Package hanna - simulations for winner-looser effects}
#' \description{This package contains the code for the paper 
#'   "Hermanussen et. al. (2023): Winner-loser effects improve social network efficiency among 
